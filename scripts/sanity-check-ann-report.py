...
def main():
    ...
    logging.info('Will operate in: ' + args.directory)
    ...
    for aid in ids:
        ...
        ###
        ### Extract information from actual.
        ###
        ...
        elif foo.returncode != 0:
            die_screaming('Bad return on: ' + str(foo))
