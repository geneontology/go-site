...
function GOOverlayInit(){
	...
	if( typeof(global_go_annotation_metadata) !== 'undefined' ){
		...
		'<thead>',
		'<tr>',
		'<th>Species/Database<img style="border: 0px;" src="http://amigo.geneontology.org/static/images/reorder.gif" title="Reorder" alt="[Reorder]" /></th>',
		'<th>Gene&nbsp;products annotated<img style="border: 0px;" src="http://amigo.geneontology.org/static/images/reorder.gif" title="Reorder" alt="[Reorder]" /></th>',
		'<th>Annotations</th>',
		'<th>Submission date<img style="border: 0px;" src="http://amigo.geneontology.org/static/images/reorder.gif" title="Reorder" alt="[Reorder]" /></th>',
		'<th>README</th>',
		'<th>File</th>',
		'</tr>',
		'</thead>',
