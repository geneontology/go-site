...
class AssembleCollection():
    ...
    def with_path(primary_filepath):
        ...
        # Open primary_filepath and split to .headers and .associations
        headers, associations = AssembleCollection.header_and_associations(primary_filepath)
        assemble_collection.headers = headers
        assemble_collection.associations = associations
        return assemble_collection

    @staticmethod
    def header_and_associations(filepath):
        headers = []
        associations = []
    ...
    def add_mixin(self, filepath):
        def make_mixin_header(header_lines, path):
            ...
            # Where does this '[8:]' come from? Oh, from here:
            # !gaf-version: 2.1
            # !
            # !Generated by GO Central
            # !
            # !Date Generated by GOC: 2021-02-01
            # !
            # !Header from paint_fb source association file:
            # !=================================
            return the_header
        ...
        ! Mixin2 header
        """
        headers, associations = AssembleCollection.header_and_associations(filepath)
        headers += make_mixin_header(headers, filepath)
        self.headers.append(headers)
        self.associations.append(associations)

    def write(self, outpath):
        with open(outpath, "w") as outfile:
            outfile.writelines(self.headers + self.associations)
